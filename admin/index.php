        ...
        <?php 
            ...
            while ($row = mysqli_fetch_row($results)) { ?>
                    ...
                    <tr> 
                        ...
                        <td class='actions'><span onclick="ondelete('vol', <?php echo $row[0]; ?>)">Delete</span> <span onclick="window.location = 'mailto-form.php?mailToVolunteer=<?php echo $row[0] ?>'">Mailto</span></td>

...
$query = "INSERT INTO organisations (username,email,password,name,website,facebook,twitter,other,description,picture) VALUES ('$user', '$email','$pass','$name','$website','$facebook','$twitter', '$other','$description', '../images/profile-pics/profile.png')";

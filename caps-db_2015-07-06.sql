...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Jul 06, 2015 at 08:30 PM
...
) ENGINE=InnoDB AUTO_INCREMENT=26 DEFAULT CHARSET=utf8 COMMENT='Holds the data for the events';

--
-- Dumping data for table `events`
--

INSERT INTO `events` (`id`, `org_id`, `title`, `category`, `address`, `str_num`, `zipcode`, `area`, `day`, `time`, `agegroup`, `skills`, `sdesc`, `ddesc`, `image`, `image2`, `image3`) VALUES
...
(18, 1, 'An Event', 'Communities', 'adad', 23, 33333, 'Ανω Τούμπα', '2015-07-08', '14:02:00', 'Kids', '37', 'An Event An Event An Event An Event An Event An Event An Event An Event An Event An Event An Event An Event ', 'An Event An Event An Event An Event An Event An Event An Event An Event An Event An Event An Event An Event An Event An Event An Event An Event An Event An Event An Event An Event An Event An Event An Event v', '', '', ''),
...
(22, 1, 'Look after the Elderly', 'Education', 'Χαλκηδόνος', 8, 55133, 'Καλαμαριά', '2015-06-11', '00:00:05', 'Adults', '39', 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Etiam placerat bibendum pretium. Aenean vel nisl nec enim pulvinar finibus.', 'Ελληνικό Ελληνικό Ελληνικό Ελληνικό Ελληνικό Ελληνικό Ελληνικό Ελληνικό Ελληνικό Ελληνικό Ελληνικό Ελληνικό Ελληνικό Ελληνικό Ελληνικό Ελληνικό Ελληνικό Ελληνικό Ελληνικό Ελληνικό Ελληνικό Ελληνικό Ελληνικό Ελληνικό Ελληνικό Ελληνικό Ελληνικό Ελληνικό Ελληνικό Ελληνικό Ελληνικό Ελληνικό Ελληνικό Ελληνικό Ελληνικό Ελληνικό Ελληνικό Ελληνικό Ελληνικό Ελληνικό ', 'images/tommylee.jpg', '', ''),

    ...
    <?php } else { ?>
        ...
        <div class="content">
            <div class="aligner">
                ...
                <h1> Νέα και Ειδήσεις </h1>
                <span class="addItem"><a href="admin-news-form.php">Προσθήκη Νέου</a></span>
                ...
                while ($row = mysqli_fetch_row($results)) { ?>
                    ...
                    <tr> 
                        ...
                        <td class='actions'><span onclick="ondelete('news', <?php echo $row[0]; ?>)">Διαγραφή</span> <span onclick="window.location = 'admin-edit-news-form.php?id='+
                        <?php echo $row[0]; ?>">Επεξεργασία</span></td>

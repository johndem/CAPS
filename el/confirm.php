	...
	<body>
        ...
        <div class="content">
            ...
            <div class="page-title"> 
                <div class="main-title">Συγχαρητήρια!</div>  
            </div>
            
            <p style="font-size:20px; margin-top: 50px;" class="aligner">Ο λογαριασμός σας δημιουργήθηκε με επιτυχία!</p>
            <p style="font-size:20px;" class="aligner"> <a href="login.php" id="confirm-link">Κάνετε είσοδο</a> στον λογαριασμό σας και ξεκινήστε!</p>

    ...
    <body>
        ...
        <div class="content">
            ...
            <div class="page-title"> 
                    <div class="main-title">Φόρμα εγγραφής οργανισμού</div>  
                    <h4>Παρακαλούμε συμπληρώστε τις απαραίτητες πληροφορίες για τον οργανισμό σας</h4>
                    </div>
                ...
                <div class="aligner">
                    ...
                    <div id="go">
                        <input type="submit" class="submitBtn" onclick="checkorgform()" id="sButton" name="submit" value="Εγγραφή" />
                    </div> 

    ...
    <body>
        ...
        <div class="content">
            ...
            <div class="page-title"> 
                <div class="main-title">Στατιστικά</div>  
                <h4>Πρόοδος Πλατφόρμας και ολοκληρωμένες εθελοντικές δράσεις</h4>
            </div>
            ...
            <div id="statistics">
                ...
                <div id="numberstats">
                    ...
                    ?>
                    <h3>Αριθμός εγγεγραμμένων εθελοντών: <?php echo mysqli_num_rows($result); ?></h3>
                    <?php  
                    $query="SELECT * FROM organisations";
                    $result = mysqli_query($link,$query);
                    ?>
                    <h3>Αριθμός εγγεγραμμένων οργανισμών: <?php echo mysqli_num_rows($result); ?></h3>
                    <?php  
                    $query="SELECT * FROM events WHERE status=2";
                    $result = mysqli_query($link,$query);
                    ?>
                    <h3>Αριθμός ολοκληρωμένων εθελοντικών δράσεων: <?php echo mysqli_num_rows($result); ?></h3>
                </div>
                
                <div id="mapstats">
                    <h4 class="left">Οπτική απεικόνιση ολοκληρωμένων εθελοντικών δράσεων</h4>
                    
                    <div id="mapstats-map"></div>
                    
                    <div id="mapstats-options">
                        <h4>Προβολή ολοκληρωμένων εθελοντικών δράσεων σε χρονική περίοδο:</h4>
                        <form method="get" action="">
                            ...
                            <div id="go">
                                <input type="submit" class="submitBtn" id="sButton" name="submit" value="Προβολή" />
                            </div>
                        </form>
                ...
                <div id="prefstats">
                    ...
                    <h4 class="left">Προτιμήσεις κατηγορίας εθελοντισμού</h4>
        ...
        <script type="text/javascript">
            ...
            function drawChart() {
                var pieInput = [['Κατηγορίες', 'Ολοκληρωμένες εθελοντικές δράσεις']];

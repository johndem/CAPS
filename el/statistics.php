    ...
    <body>
        ...
        <div class="content">
            ...
            <div class="page-title"> 
                <div class="main-title">Στατιστικά εθελοντισμού</div>  
                <h4>Εθελοντικές δράσεις που ολοκληρώθηκαν στην πόλη σε μια χρονική περίοδο.</h4>
            </div>
            ...
            <div id="statistics">
                ...
                <div id="stats">
                    ...
                    <div id="stats-options">
                        <h2>Επιλέξτε χρονική περίοδο σε μήνες:</h2>

            ...
            <div class="page-title">
                ...
                <div id="account">
                    ...
                    session_start();
                       ...
                       $query = "SELECT achievments.text, achievments.badge FROM achievments,earnedachievements,user WHERE achievments.id = earnedachievements.achiev_id AND earnedachievements.user_id = user.id AND user.id = $user";

    ...
    <body>
        ...
        <div class="content">
            <div class="aligner">
                ...
                <div id="go">
                    <input type="submit" class="submitBtn" onclick="checkEditNewsForm()" id="sButton" name="submit" value="Edit" />
                </div> 

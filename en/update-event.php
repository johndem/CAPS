...
<html lang="el">
        ...
        <div class="content">
            ...
            <div class="aligner">
                ...
                <form>
                    ...
                    <div class="div-cat"> <h1 class="cats">Image</h1> </div>
    ...
    <!--          <div class="label-in"> 
            ...
            -->
                    ...
                    <div class="div-cat"> <h1 class="cats">Additional infromation</h1> </div>
                    ...
                    <div class="label-in">
                        <div class="h3">Skills required: * </div>
                        ...
                        <select id="skills" class="in" multiple required>
                            <option disabled value="0">- Hold Ctr for multiple options -</option>
                            <?php
                                include '../back-end/create-link.php';

    ...
    <body>
        ...
        <div class="content">
            ...
            <div class="page-title"> 
                <div class="main-title"> Filtered search</div>  
                <h4> Search for volunteering opportunities and get started! </h4>
            </div>
                    ...
                    <div class="search-select">
                        ...
                        <div class="in">
                            <select id="skills" name="skills" multiple>
                                <option disabled selected="selected">- Hold Ctr for multiple options -</option>
                                <?php
                                    include 'create-link.php';
